...
int main() {
    string train_images_path = "/mnt/e/MachineLearningAndGenAI/OCR_Project_in_CPP/dataset/train-images.idx3-ubyte";
    string train_labels_path = "/mnt/e/MachineLearningAndGenAI/OCR_Project_in_CPP/dataset/train-labels.idx1-ubyte";
    string test_images_path  = "/mnt/e/MachineLearningAndGenAI/OCR_Project_in_CPP/dataset/t10k-images.idx3-ubyte";
    string test_labels_path  = "/mnt/e/MachineLearningAndGenAI/OCR_Project_in_CPP/dataset/t10k-labels.idx1-ubyte";
