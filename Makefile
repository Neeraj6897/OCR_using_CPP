CXX = g++
CXXFLAGS = -fopenmp -std=c++17 -g -O3 -I. `pkg-config --cflags opencv4`
...
VERIFY_EXECUTABLE = verify_correctness

all: $(TRAINING_EXECUTABLE) $(INFERENCE_EXECUTABLE) $(VERIFY_EXECUTABLE)
...
$(VERIFY_EXECUTABLE): nn_correctness.cpp neural_network/nn_layer.cpp timer.cpp
	$(CXX) $(CXXFLAGS) $^ -o $@

clean:
	rm -f $(TRAINING_EXECUTABLE) $(INFERENCE_EXECUTABLE) $(VERIFY_EXECUTABLE)
